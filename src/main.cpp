...
uint256 hashGenesisBlock("0x00000000d97143a39c154c1567389a38942b6a90ed5a0fb32509a823c2d2600b");
...
const string strMessageMagic = "DecryptRcoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 40000 blocks, which will occur approximately every 4 years
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000d97143a39c154c1567389a38942b6a90ed5a0fb32509a823c2d2600b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1421274372;
        block.nBits    = 486604799;
        block.nNonce   = 2993331946;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("DecryptRcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DecryptRcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("DecryptRcoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running DecryptRcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("DecryptRcoinMiner terminated\n");
        throw;
    }
}
